...
# Load the data from the specific file mentioned
df = pd.read_csv('/Volumes/ExtremeSSD/Universidad/DecimoSemestre/MineriaDatos/mineria-de-datos/PrediccionRandomForestJornada17/dataset_liga_mx_jornadas_13_14_15_16_base.csv')
...
print("Predictions for Jornada 17 (Trained on J15 only):")
for local, visita in matches_j17:
    ...
    print(f"{local} vs {visita}: {res_str} (Pred: {pred})")
